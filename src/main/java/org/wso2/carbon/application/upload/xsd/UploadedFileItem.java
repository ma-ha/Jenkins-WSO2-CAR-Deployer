...
@XmlType(name = "UploadedFileItem", propOrder = {
    "dataHandler",
    "fileName",
    "fileType"
})
public class UploadedFileItem {
    ...
    @XmlElementRef(name = "dataHandler", namespace = "http://upload.application.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> dataHandler;
    @XmlElementRef(name = "fileName", namespace = "http://upload.application.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fileName;
    @XmlElementRef(name = "fileType", namespace = "http://upload.application.carbon.wso2.org/xsd", type = JAXBElement.class, required = false)
